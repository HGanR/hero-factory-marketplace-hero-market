...
import { approveBentleyApprovalRequest } from "@/lib/revenue-os/autonomous-approval-queue";
...
export async function POST(req: NextRequest) {
  ...
  try {
    logBentleyCorrelationEvent("revenue-os/autonomous/approval-requests/approve", req);
    ...
    const r = await approveBentleyApprovalRequest({
      userId: uid,
