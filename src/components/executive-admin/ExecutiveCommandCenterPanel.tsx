...
export function ExecutiveCommandCenterPanel({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "" : "mt-4 rounded-xl border border-red-500/30 bg-slate-950/70 p-4"}>
      {!embedded ? (
