...
export function AiRevenueOsSharedStateProvider({ children }: { children: ReactNode }) {
  ...
  const profileValue = useMemo<AiRevenueOsProfileValue>(
    () => ({
      ...
      industry,
      setIndustry,
      contentIndustry: coerceTrimmedString(contentIndustry),
      setContentIndustry,
      effectiveIndustryLabel,
      targetAudience: coerceTrimmedString(questionnaireAnswers.targetAudience),
      setTargetAudience,
      platforms: coercePlatformLabelStrings(questionnaireAnswers.socialPlatforms),
      setPlatforms,
      questionnaireAnswers: {
        ...questionnaireAnswers,
        targetAudience: coerceTrimmedString(questionnaireAnswers.targetAudience),
        notes: coerceTrimmedString(questionnaireAnswers.notes),
      },
      setQuestionnaireAnswers,
      businessName: coerceTrimmedString(businessName),
      setBusinessName,
      coreOffer: coerceTrimmedString(coreOffer),
      setCoreOffer,
      transformation: coerceTrimmedString(transformation),
      setTransformation,
    }),
    [
      industryKey,
  ...
  const contentCampaignValue = useMemo<AiRevenueOsContentCampaignValue>(
    () => ({
      isProviderActive: true,
      tone: coerceTrimmedString(tone, "Professional"),
      setTone,
      contentType: coerceTrimmedString(contentType, "Full Post"),
      setContentType,
      imageStyle: coerceTrimmedString(imageStyle, "cinematic"),
      setImageStyle,
      contentPlatformId: coerceTrimmedString(contentPlatformId, "instagram"),
      setContentPlatformId,
      campaignNotes: coerceTrimmedString(campaignNotes),
      setCampaignNotes,
    }),
